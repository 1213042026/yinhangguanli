...
<TABLE  bgColor=#eef8fe cellSpacing=0 cellPadding=0 width="90%" align=center border=0>
  ...
  <TABLE width="100%" border="0" align="center"style="cursor:hand" onclick=javascript:expand(1)>
    <TR>
    <TD height="31" background="<%=basePath %>member/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %>member/images/linkbg1.gif" >&nbsp;<IMG src="<%=basePath %>member/images/menu.gif" align=absMiddle><a href="<%=basePath %>member/info/<%=url %>" target="MainFrame">我的详细资料</a></TD></TR>
    </TABLE>
  </TD>
  </TR>
  <TR ParentID="SystemLastArticle" AllParentID="SystemLastArticle">
  ...
  <TR>
    <TD height="31" background="<%=basePath %>member/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %>member/images/linkbg1.gif" >&nbsp;<IMG src="<%=basePath %>member/images/menu.gif" align=absMiddle><a href="<%=basePath %>member/job/default.jsp" target="MainFrame">存取款记录</a></TD></TR>
  </TABLE>
  </TD>
  </TR>
   <TR ParentID="SystemLastArticle" AllParentID="SystemLastArticle">
  ...
  <TR>
    <TD height="31" background="<%=basePath %>member/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %>member/images/linkbg1.gif" >&nbsp;<IMG src="<%=basePath %>member/images/menu.gif" align=absMiddle><a href="<%=basePath %>member/job/cq.jsp" target="MainFrame">存取款操作</a></TD></TR>
 </TABLE>
  </TD>
  </TR>
  ...
  <TR>
    <TD height="31" background="<%=basePath %>member/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %>member/images/linkbg1.gif" >&nbsp;<IMG src="<%=basePath %>member/images/menu.gif" align=absMiddle><a href="<%=basePath %>member/job/cuninfo.jsp" target="MainFrame">存款信息查询</a></TD></TR>
  </TABLE>
   </TD>
  </TR>
  <TR ParentID="SystemLastArticle" AllParentID="SystemLastArticle">
  ...
  <TR>
    <TD height="31" background="<%=basePath %>member/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %>member/images/linkbg1.gif" >&nbsp;<IMG src="<%=basePath %>member/images/menu.gif" align=absMiddle><a href="<%=basePath %>member/job/quinfo.jsp" target="MainFrame">取款信息查询</a></TD></TR>
  </TABLE>
   </TD>
  </TR>
  <TR ParentID="SystemLastArticle" AllParentID="SystemLastArticle">
  ...
  <TR>
    <TD height="31" background="<%=basePath %>member/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %>member/images/linkbg1.gif" >&nbsp;<IMG src="<%=basePath %>member/images/menu.gif" align=absMiddle><a href="<%=basePath %>member/job/yuinfo.jsp" target="MainFrame">帐号余额查询</a></TD></TR>
  </TABLE>
    </TD>
  </TR>
