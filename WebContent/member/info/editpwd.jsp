...
<TABLE align="center" height="100%" cellSpacing=0 cellPadding=0 width="40%" border=0>
  ...
  <TR>
	...
	<form action="<%=basePath %>ZhServlet" method="post" name="form1" onSubmit="return check()">
		 <TABLE width="409" border=0 align="center" cellPadding=3 cellSpacing=1 class=tablewidth height="171">
			<TBODY>
			<TR class=head>
			<TD colSpan=2 height=23>修改后台登录密码 当前用户：<FONT color=red><%=member %></FONT>&nbsp;&nbsp;（密码为6-16位之间）</TD></TR>
			<TR bgColor=#ffffff>
			<TD width="50%" align="right" id=map>旧 密 码：<input type="hidden" name="method" value="upZHPwd"/></TD>
